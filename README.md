...
### 주요화면 및 기능
<img width="1784" alt="image" src="https://github.com/jhkimon/mz-hackathon/assets/113989454/94d9ff16-1452-4661-a007-7dd101cde600">

&nbsp;

### 1. 이름이 뭐에요? 📞
- localstorage를 활용한 username 저장
- 게임 스타트 => 설명으로 이동

<img width="1754" alt="image" src="https://github.com/jhkimon/mz-hackathon/assets/113989454/4ad37fc3-ad07-4b3e-a33d-6c4e8778d202">

&nbsp;

### 2. 신조어를 맞춰봐요 🙄
- localstorage를 활용한 user별 맞은 개수 저장
- DB에 저장된 문제를 랜덤하게 추출
- 5개의 질문 이후 기믹이 등장
- 제한시간에 맞게 빨간 바 감소

<img width="1705" alt="image" src="https://github.com/jhkimon/mz-hackathon/assets/113989454/a8253e31-7aba-4273-bf5e-7f910b6242a7">

&nbsp;


### 3. 타이머를 잡아보아요 ⏰
- timer: 드래그를 통해 타이머를 잡기

https://github.com/jhkimon/mz-hackathon/assets/113989454/23bd532c-e4ed-452f-bb27-b7484553fd38

&nbsp;

### 4. 사라지는 답을 쫓아가요 🚀
- button fadeout: 커서가 정답 버튼 위로 가면 버튼이 사라짐
- sweep: 타이머 시작 3초 후에 정답이 타이머 위를 지나감
